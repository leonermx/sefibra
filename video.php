                        ...
                        <div class="col-md-4">
                            <div class="project-img">
                                    ...
                                    <div class="footer-info-right">
                                        ...
                                        <img  class="modernito" src="images/products/sony.jpg" alt="Marca"> 
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li>
                                    Sistemas de video para: Casas, oficinas, auditorios, salas, salones, explanadas, comedores, centros comerciales, parques y plazas.  </li>
                                    <li>  <img src="images/products/video.jpg" alt="Msrca">  </li>
