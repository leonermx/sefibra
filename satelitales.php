                        ...
                        <div class="col-md-4">
                            <div class="project-img">
                                    ...
                                    <div class="footer-info-right">
                                        ...
                                        <img  class="modernito" src="images/products/idirect.jpg" alt="Marca"> 
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li>
                                    La comunicación bidireccional móvil por satélite RaySat ofrece comunicaciones de seguridad nacional, atendiendo las necesidades gubernamentales, así como la seguridad privada y el seguimiento de activos. La conectividad RaySat también permite comunicaciones de respaldo confiables e implementadas con rapidez a gran escala para servicios de rescate y socorristas. 
...
Maritmos</li>
                                    <li>  <img src="images/products/satellitales.jpg" alt="Msrca">  </li>
