                ...
                <div class="row">
                        <div class="col-md-4">
                            <div class="project-img">
                                    ...
                                    <div class="footer-info-right">
                                        ...
                                        <img  class="modernito" src="images/products/yamaha.jpg" alt="Marca"> 
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li><h3>Sistemas de Audio</h3>
                                    Sistemas de sonido ambiental y voceo para: Casas, oficinas, Auditorios, Salones, Centros comerciales, Parques y Plazas. 

</li>
                                    <li>  <img src="images/products/audio.jpg" alt="Msrca">  </li>
