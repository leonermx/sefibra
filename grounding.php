...
<html lang="es">
  <head>
    <title>Grounding and Bounding</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li>
                                    Concepto Protegen contra descargas atmosféricas derivada de alguna instalación eléctrica o evento en el suministro eléctrico (corriente estática por ejemplo).

Beneficios:
<br>
Brinda seguridad de las personas.
Asegura las instalaciones eléctricas.
Garantiza la compatibilidad electromagnética. </li>
                                    <li>  <img src="images/products/grounding.jpg" alt="Msrca">  </li>
