                ...
                <div class="row">
                        <div class="col-md-4">
                            <div class="project-img">
                                    ...
                                    <div class="footer-info-right">
                                        ...
                                        <img  class="modernito" src="images/products/alliance.jpg" alt="Marca"> 
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li> <h3>Solución práctica para difusión de contenido multimedia como música, imágenes y video.</h3>
La técnica del Streaming consiste la reproducción de un archivo de audio o video de manera simultanea durante su descarga.

Funcionamiento en redes IP, a través de un servidor central con la aplicación de Stream Server y los diferentes hosts comúnmente: Pantallas Smart TV que tienen acceso vía network IP al servidor. </li>
                                    <li>  <img src="images/products/videostreaming.jpg" alt="Msrca">  </li>
