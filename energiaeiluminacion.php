...
<html lang="es">
  <head>
    <title>Energia e Iluminación</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="col-md-4">
                            <div class="project-img">
                                    ...
                                    <div class="footer-info-right">
                                        <ul><h1>Sistemas de Energía e Iluminación</h1>
                                        ...
                                        <img  class="modernito" src="images/products/lledo.jpg" alt="Marca"> 
                        ...
                        <div class="col-md-8">
                            <div class="project-quick-info">
                                <ul>
                                    <li> </li>                                
                                    <li>
                                    Sistemas de ENERGÍA iluminación para: Casas, oficinas, auditorios, salas, salones, explanadas, comedores, centros comerciales, parques y plazas. </li>
                                    <li>  <img src="images/products/iluminacion.jpg" alt="Msrca">  </li>
